...
+(void)deleteMessagesInConversationID:(NSURL *)convoID
{
    ...
    if (conversation)
    {
        [self deleteMessagesInConversation:conversation];
    }
    else
    {
        //FATAL ERROR
...
{
    LYRConversation *conversation = [LayerConversation queryForConversationWithHostName:hostName];
    if (conversation)
    {
        [self deleteMessagesInConversation:conversation];
    }
...
+(void)deleteMessagesInConversation:(LYRConversation *)conversation
{
